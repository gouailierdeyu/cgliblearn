...
public class Enhancer extends AbstractClassGenerator
{
    ...
    public interface EnhancerKey {
        public Object newInstance(String type, // 父类
                                  String[] interfaces, // 实现的接口
                                  WeakCacheKey<CallbackFilter> filter, //回调过滤器
                                  Type[] callbackTypes, // 回调类型
                                  boolean useFactory,
     ...
     * @see Factory
     */
    public Enhancer() {   //Source类型 只有string name一个字段
        super(SOURCE);
    }
     ...
     * 设置生成类是否要实现工厂接口 生成类参考factorybean和bean
     */
